...
volume: vol47-48
categories: vol47-48
title: "Imagining an Autochthonous Music: The First Movement of W.G. Still's Fourth Symphony"
author: "David Hier"
short-name: "hier"
abstract: "William Grant Still occupied a singularly exalted place in American music during the 1930s and 1940s. His music was recognized as being emblematic of American music and life both in the United States and abroad. He himself argued that his music combined a variety of influences to produce a style that reflected the diversity of American life. Still's Fourth Symphony, subtitled &quotAutochthonous&quot encapsulates his mature style and its subtitle suggests a musical language deeply rooted in American idioms. The assuredness and craftsmanship of the symphony, however, belie Still's earlier struggles to find his voice and to reconcile competing perspectives about the relationship of Black artists to European and modernist art forms. Still's Fourth Symphony offers his solution to these problems by triangulating the European common-practice, international modernist, and African and African-American musical styles. The first movement incorporates the three influences deeply into its compositional fabric and I employ a variety of analytical techniques to illustrate its stylistic pluralism. I argue that the movement articulates a view of American autochthony that is paradoxically pluralist and conclude by assessing the success of Still's symphony from this perspective."
sections:  
    - header: 
        text: "Still's Music: Musical and Social Contexts"
        id: "stills-music-musical-and-social-contexts"
    - header: 
        text: "European Art-Music Tradition, Modernism, and African(-American) Elements"
        id: "european-art"
    - header: 
        text: "The First Movement of the Fourth Symphony as a Whole"
        id: "the-first-movement-of-the-fourth-symphony-as-a-whole"
    - header: 
        text: "Hermeneutics and Concluding Remarks"
        id: "hermeneutics-and-concluding-remarks"
    - header: 
        text: "Works Cited"
        id: "works-cited"
author-info-short: "<strong>David Hier</strong> currently serves as Assistant Professor of Music Theory at Oklahoma State University."
author-info-long: "<strong>David Hier</strong> currently serves as Assistant Professor of Music Theory at Oklahoma State University,
where he teaches the core undergraduate curriculum and master’s seminars. Hier’s articles on
the music of Wolfgang Rihm and Arnold Schoenberg have appeared in <em>Music Theory Online</em>. He
has presented papers on Rihm, Schoenberg, Roger Sessions, and Max Reger at various regional,
national, and international conferences. His other research interests include chromatic harmony,
late-romantic form, and public music theory. Hier is also an active composer: a concert of his
chamber music will be given in Brussels, Belgium in March, 2024 under the direction of Murielle
Lemay. Outside of music, Hier is an avid chess player and film buff."
permalink: vol47/hier
---
...
<section markdown="1">
<h2 id='stills-music-musical-and-social-contexts'>Still's Music: Musical and Social Contexts</h2>
...
characterizes American individualism and enterprise.{% include footnote.html footnote_number='1' footnote_text=site.data.hier.footnote_1 %}
...
music that emerges from and could only emerge from American soil.{% include footnote.html footnote_number='2' footnote_text=site.data.hier.footnote_2 %}
...
<h2 id="european-art">European Art-Music Tradition, Modernism, and African(-American) Elements</h2>
...
subjects in the home key.{% include footnote.html footnote_number='3' footnote_text=site.data.hier.footnote_3 %} I will return to a closer reading of the
piece's form below.
...
early twentieth century.{% include footnote.html footnote_number='4' footnote_text=site.data.hier.footnote_4 %} Still acknowledges the influence of an
...
multiplicity-in-unity" (Solie 1980, 148). **[Example 2](#ex-2)**
provides the primary thematic material for the whole movement. Its
opening motto contains three motives---x, y, and z---which are used to
build the first and second subjects.{% include footnote.html footnote_number='5' footnote_text=site.data.hier.footnote_5 %} The first subject begins with
...
African-American music.{% include footnote.html footnote_number='6' footnote_text=site.data.hier.footnote_6 %} More recently, Christopher Jenkins has
...
whose pitches relate closely to the harmonic series.{% include footnote.html footnote_number='7' footnote_text=site.data.hier.footnote_7 %} In many of
...
to the hemiolas of Brahms.{% include footnote.html footnote_number='8' footnote_text=site.data.hier.footnote_8 %} Harmonic planing evokes faux-bourdon as
...
foundation of jazz and central African music,{% include footnote.html footnote_number='9' footnote_text=site.data.hier.footnote_9 %} The symphonic form is
...
<section markdown="1">
<h2 id='the-first-movement-of-the-fourth-symphony-as-a-whole'>The First Movement of the Fourth Symphony as a Whole</h2>
...
<h3 id='b)-first-subject-and-transition'>b) First Subject and Transition</h3>
...
strident development section (discussed below).{% include footnote.html footnote_number='10' footnote_text=site.data.hier.footnote_10 %} The dissonant
...
period with rousing syncopations associated with jazz. [Example
4](#ex-4) provides a rhythmic analysis of the syncopations. The
...
politics by some artists of his time.{% include footnote.html footnote_number='11' footnote_text=site.data.hier.footnote_11 %} Still's optimism stands in
...
<h3 id='c)-second-subject'>c) Second Subject</h3>
...
to G<span style="font-family: music;">&#x266D;</span> major in m. 45 (the neo-Riemannian "slide" transformation).{% include footnote.html footnote_number='12' footnote_text=site.data.hier.footnote_12 %}
...
{E<span style="font-family: music;">&#x266D;</span>, G, B, D} becomes {G, C<span style="font-family: music;">&#x266D;</span>, E<span style="font-family: music;">&#x266D;</span>, G<span style="font-family: music;">&#x266D;</span>}.{% include footnote.html footnote_number='13' footnote_text=site.data.hier.footnote_13 %} But the bass also contains
...
<h3 id='d)-development'>d) Development</h3>
...
[Examples 8](#ex-8) and [9](#ex-9) provide piano reductions of the A
sections, and Examples [10](#ex-10), [11](#ex-11), and [12](#ex-12) provide piano reductions
...
<h3 id='a-sections'>A Sections</h3>
...
below).{% include footnote.html footnote_number='14' footnote_text=site.data.hier.footnote_14 %} Harmonies arise from the mostly stepwise parallel motion of
...
traditions.{% include footnote.html footnote_number='15' footnote_text=site.data.hier.footnote_15 %}
...
<h3 id='b-sections'>B Sections</h3>
...
Example 10. Still transforms the subject from a period into an extended
...
Example 11 provides the second rotation of the B section, B2, which
...
American music.{% include footnote.html footnote_number='16' footnote_text=site.data.hier.footnote_16 %}
...
The third rotation of the development's B section, provided in Example
12, includes some of the most dissonant harmony and extended process of
...
combination of A7 and A half-diminished, or A<span style="font-family: music;">&#x266F;</span>9<span style="font-family: music;">&#x266D;</span>5, a chord common to
...
recapitulation will solve.{% include footnote.html footnote_number='17' footnote_text=site.data.hier.footnote_17 %}
...
<h3 id='e)-recapitulation'>e) Recapitulation</h3>
...
<section markdown="1">
<h2 id='hermeneutics-and-concluding-remarks'>Hermeneutics and Concluding Remarks</h2>
