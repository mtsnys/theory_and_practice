...
sections:  
    - header: 
        ...
        id: "introduction"
    - header: 
        text: "Part I: Context and Approach"
        id: "part-i:-context-and-approach-"
    - header: 
        text: "Part II: Analysis of Sonata No. 1 for Flute and Piano"
        id: "part-ii:-analysis-of-sonata-no.-1-for-flute-and-piano"
    - header: 
        text: "Conclusion"
        id: "conclusion"     
    - header: 
        text: "Works Cited"
        id: "works-cited"                    
author-info-short: "<strong>Samantha M. Inman</strong> is an Associate Professor and the Coordinator of Music Theory at Stephen
F. Austin State University."
author-info-long: "<strong>Samantha M. Inman</strong> is an Associate Professor and the Coordinator of Music Theory at Stephen
F. Austin State University. She formerly taught at the University of North Texas, and she holds a Ph.D.
in music theory from the Eastman School of Music. Particularly interested in eighteenth-century
music and literature for winds, her research specialties include form, pedagogy, and Schenkerian
analysis. She has presented at conferences including the Society for Music Theory, the Texas
Society for Music Theory, Pedagogy into Practice, and the Society for Christian Scholarship in
Music. Her publications appear in <em>Artistic Theologian</em>, <em>BACH: Journal of the Riemenschneider Bach
Institute</em>, <em>Haydn: The Online Journal of the Haydn Society of North America</em>, <em>Indiana Theory Review</em>,
the <em>Journal of Music Theory Pedagogy</em>, and <em>Theory and Practice.</em>"
permalink: vol47/inman
---


<section markdown="1">
<h2 id='introduction'>Introduction</h2>
Tonal contemporary art music has received little attention from music
theorists despite its popularity with performers and audiences.{% include footnote.html footnote_number='1' footnote_text=site.data.inman.footnote_1 %} This
...
2009, 140).{% include footnote.html footnote_number='2' footnote_text=site.data.inman.footnote_2 %} His output divides almost evenly into programmatic and
non-programmatic works. The latter includes compositions in traditional
genres such as concertos and sonatas.{% include footnote.html footnote_number='3' footnote_text=site.data.inman.footnote_3 %} Much of the fascination of his
...
form and tonality in Ewazen's Sonata No. 1 for Flute and Piano.{% include footnote.html footnote_number='4' footnote_text=site.data.inman.footnote_4 %} The
...
<section markdown="1">
<h2 id='part-i:-context-and-approach-'>Part I: Context and Approach </h2>
> I have really embraced tonality as my main voice. I always have tonal
...
> but sometimes using mixed meters as well (Ewazen in Madden 2002,
> 139--140).
...
including pentatonic, octatonic, and whole tone.{% include footnote.html footnote_number='5' footnote_text=site.data.inman.footnote_5 %} Second, forgoing
...
parents.{% include footnote.html footnote_number='6' footnote_text=site.data.inman.footnote_6 %}
...
admires based on style.{% include footnote.html footnote_number='7' footnote_text=site.data.inman.footnote_7 %} The remainder of this section considers
...
some of the same traits.{% include footnote.html footnote_number='8' footnote_text=site.data.inman.footnote_8 %} References to traditional forms are common
...
movement ends."{% include footnote.html footnote_number='9' footnote_text=site.data.inman.footnote_9 %}
...
precedents in Schubert (2011, 144--159).{% include footnote.html footnote_number='10' footnote_text=site.data.inman.footnote_10 %} Ravel's Piano Trio (1914)
...
though other collections surface occasionally.{% include footnote.html footnote_number='11' footnote_text=site.data.inman.footnote_11 %} [Example 2](#ex-2) shows a phrase from the second movement of Ewazen's
...
some of these scalar shifts (2011, 144--59).{% include footnote.html footnote_number='12' footnote_text=site.data.inman.footnote_12 %} Andrew Aziz (2020)
...
Given Ewazen's "folkish, Vaughan-Williams-like use of modes,"{% include footnote.html footnote_number='13' footnote_text=site.data.inman.footnote_13 %}
...
domain to D~D~" (D Dorian).{% include footnote.html footnote_number='14' footnote_text=site.data.inman.footnote_14 %} In subsequent analyses in the article,
...
passages.{% include footnote.html footnote_number='15' footnote_text=site.data.inman.footnote_15 %} For example, the passage from the Sonata for Horn and
...
as Copland, Barber, Schuman, Bernstein, and Gershwin."{% include footnote.html footnote_number='16' footnote_text=site.data.inman.footnote_16 %} Sonorities
...
5](#ex-5).{% include footnote.html footnote_number='17' footnote_text=site.data.inman.footnote_17 %} This passage also exemplifies the tonic pedal
...
the analysis of Ewazen's music below.{% include footnote.html footnote_number='18' footnote_text=site.data.inman.footnote_18 %}
...
for a specific person.{% include footnote.html footnote_number='19' footnote_text=site.data.inman.footnote_19 %} Another reason might be the influence of
...
of formal processes and specific examples of sonata cycle works.{% include footnote.html footnote_number='20' footnote_text=site.data.inman.footnote_20 %}
...
<section markdown="1">
<h2 id='part-ii:-analysis-of-sonata-no.-1-for-flute-and-piano'>Part II: Analysis of Sonata No. 1 for Flute and Piano</h2>
<h3 id='movement-i:-allegro-leggiero'>Movement I: Allegro leggiero</h3>
...
(**[Example 10](#ex-10)**) and second (**[Example 11](#ex-11)**)
...
{% include figure_grid.html columns=1 figure_key='figure_10a' %}

{% include figure_grid.html columns=1 figure_key='figure_10b' %}

{% include figure_grid.html columns=1 figure_key='figure_10c' %}
...
14](#ex-14a).{% include footnote.html footnote_number='21' footnote_text=site.data.inman.footnote_21 %} The main theme (Example 14a) is by far the most
stable, exploring only three tonalities, two sharing E<span style="font-family: music;">&#x266D;</span> as tonic and two
...
the main theme and tighter than the transition.{% include footnote.html footnote_number='22' footnote_text=site.data.inman.footnote_22 %} While the
...
featuring E<span style="font-family: music;">&#x266D;</span> Ionian at the subordinate theme's opening in m. 59 and C
Ionian at the repetition in m. 73.

{% include figure_grid.html columns=3 figure_key='figure_14' %}
...
before material drawn from the transition.{% include footnote.html footnote_number='23' footnote_text=site.data.inman.footnote_23 %} In contrast to the major
...
{% include figure_grid.html columns=2 figure_key='figure_15_16' %}
...
around the pitches E<span style="font-family: music;">&#x266D;</span> and C. The soaring main theme opens the work in E<span style="font-family: music;">&#x266D;</span>
Lydian, with later passages shading into Ionian (Example 10). The bass
line alternates pedal tones on E<span style="font-family: music;">&#x266D;</span> with those on C without seriously
challenging E<span style="font-family: music;">&#x266D;</span> as the clear tonal center. In contrast, Example 12 shows
how the subordinate theme in the exposition intensifies the competition
between these two pitches through scalar shifts. The passage opens in E<span style="font-family: music;">&#x266D;</span>
...
thus reaffirms the importance of E<span style="font-family: music;">&#x266D;</span>, elevates the role of C, and
...
different starting scale degrees: <span style="font-family: music;">&#xEF02;</span> to <span style="font-family: music;">&#xEF00;</span> in the exposition and <span style="font-family: music;">&#xEF04;</span>
to <span style="font-family: music;">&#x266D;</span>3 in the development. The second iteration in the development
...
perfect fifth from <span style="font-family: music;">&#xEF04;</span> to <span style="font-family: music;">&#xEF00;</span> of the development. The flute adds its
...
{% include footnote.html footnote_number='24' %} [Example 16](#ex-16) highlights how the loop from the
exposition's main theme is transformed into the directed motion from two
modes on E<span style="font-family: music;">&#x266D;</span> to the same two modes on C in the recapitulation and
coda.{% include footnote.html footnote_number='25' footnote_text=site.data.inman.footnote_25 %}
...
principle.{% include footnote.html footnote_number='26' footnote_text=site.data.inman.footnote_26 %} The movement starts and ends in different tonalities,
but the specific choice of ending tonal center and mode nevertheless
contributes to unity.

<h3 id='movement-ii:-andante-teneramente'>Movement II: Andante teneramente</h3>
...
\<021\>.{% include footnote.html footnote_number='27' footnote_text=site.data.inman.footnote_27 %} Some modified restatements preserve set class while
...
traversing A<span style="font-family: music;">&#x266D;</span> and G<span style="font-family: music;">&#x266F;</span>. As the reduction in **[Example 23](#ex-23)**
...
<h3 id='movement-iii:-allegro-giocoso-'>Movement III: Allegro giocoso </h3>
...
[25](#ex-25), [26](#ex-26), and [27](#ex-27). Comparing the three sections reveals a slight
...
{% include figure_grid.html columns=3 figure_key='figure_25_26_27' %}
...
tonality also used at the end of episode 1 and the beginning of episode 2. Like the first movement, the finale announces the coda with a
...
minor-to-major narratives in sonatas.{% include footnote.html footnote_number='28' footnote_text=site.data.inman.footnote_28 %} In particular, though, this
...
{% include figure_grid.html columns=1 figure_key='figure_28a' %}

{% include figure_grid.html columns=1 figure_key='figure_28b' %}
...
theme b (Example 19) and the end of the coda. The third movement leans
...
living composer popular with both performers and audiences.{% include footnote.html footnote_number='29' footnote_text=site.data.inman.footnote_29 %} As with
