...
sections:  
    ...
    - header: 
        text: "Works Cited"
        id: "works-cited"
author-info: "<strong>David Hier</strong> currently serves as Assistant Professor of Music Theory at Oklahoma State University,
...
{% include footnote.html footnote_number='14' footnote_text=site.data.hier.footnote_14 %}: Blues scales typically feature scale-degree <span style="font-family: music;">&#x266F;</span>4/<span style="font-family: music;">&#x266D;</span>5 in addition to a minor third above the tonic. For more on blues scales see Chodos 2018, which summarizes different theoretical approaches to the blues scale and questions its validity as a theoretical construct. Most theories of the scale include \^<span style="font-family: music;">&#x266D;</span>3, \^∂3, \^<span style="font-family: music;">&#x266F;</span>4, \^<span style="font-family: music;">&#x266D;</span>7, and \^∂7 without \^<span style="font-family: music;">&#x266D;</span>6. In the passage cited, Still combines the sound of the blue scale with passages that correspond more closely to the minor mode, for example the inclusion of \^<span style="font-family: music;">&#x266D;</span>6 and short melodic-minor scale-fragments, A--B--C<span style="font-family: music;">&#x266F;</span>--D.
...
10. ---------. 2021. "The 'Iconic Cadence': A Post-Romantic Case of Cadential Nostalgia and Irony." EUROMAC 2021, Moscow, Russia. Unpublished conference paper.
