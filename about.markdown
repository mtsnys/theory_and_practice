...
<section markdown="1">
  ...
  <p>This online version of <em>Theory and Practice</em> is open access, with articles freely available thanks to the support of the members of the <a href="mtsnys.org">Music Theory Society of New York State</a>. It was created and is maintained by <a href="mailto:bmoseley@buffalo.edu">Brian Moseley</a>, drawing on an approach to information design pioneered by <a href="https://en.wikipedia.org/wiki/Edward_Tufte">Edward Tufte</a> and Dave Liepmann's <a href="https://edwardtufte.github.io/tufte-css/">Tufte CSS</a>.</p>
</section>
<hr>
<hr>
...
<div><h2>Theory and Practice Staff</h2>
	<ul style="list-style: none;">
		<li><strong>Editors</strong>: <a href="mailto:khutchinson1@colgate.edu">Kyle Hutchinson</a> (Colgate University) and <a href="mailto:segallcr@ucmail.uc.edu">Christopher Segall</a> (University of Cincinnati)</li>
